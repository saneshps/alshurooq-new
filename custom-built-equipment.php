...
<head>
	...
	<link rel="canonical" href="https://alshurooq.ae/custom-built-equipment.php">
...
<body>
	...
	<section id="banner-ab">
		<div class="ban-cap">
			<!-- <h2>About Us</h2> -->
			<a href="index.php">HOME</a><span> / </span><a href="products.php" class="">PRODUCTS</a> <span> / </span><a class="act">Fabrication</a><span> / </span><a href="custom-built-equipment.php" class="act-f">Custom Built Equipments</a>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="w3-content w3-display-container">
						<img class="mySlides" src="img/custom-built-equipment.jpg" style="width:100%">
					...
					<h2 class="cl">Custom Built Equipments</h2>
					<p>One of the advantages what we are offering to the food processing industry is our ability and capability to offer various custom built equipment as per their needs. Coupled with a strong local technical support, we strongly believe that we can provide value for money and complete peace of mind to the customers.</p><!-- 
