...
<head>
	...
	<link rel="canonical" href="https://alshurooq.ae/industrial-conveyors.php">
...
<body>
	...
	<section id="banner-ab">
		<div class="ban-cap">
			<!-- <h2>About Us</h2> -->
			<a href="index.php">HOME</a><span> / </span><a href="products.php" class="">PRODUCTS</a> <span> / </span><a class="act">Fabrication</a><span> / </span><a href="industrial-conveyors.php" class="act-f">Industrial Conveyors</a>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="w3-content w3-display-container">
						<img class="mySlides" src="img/industrial-conveyors.jpg" style="width:100%">
						<!--<img class="mySlides" src="img/industrial-conveyors1.jpg" style="width:100%">
					...
					<h2 class="cl">Industrial Conveyors</h2>
					<p>Conveyors for different applications can be made according to the customer specification. Sometimes it is important to plan the processing of food products as per the space limitations. We use all electrical components and drive Motors from reputed brands in Europe. Conveyors made out of Stainless steel for food and chemical applications can be made as per customer specification and requirement.</p><!-- 
