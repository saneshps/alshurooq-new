				...
				<div class="col-md-5 col-sm-12 col-xs-12">
					...
					<a href="">
						<div class="one">
							...
							<div class="ar"><i class="demo-icon icon-right-open">&#xe800;</i></div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-3 col-sm-12 col-xs-12">
					...
					<p>It started its operation in the emirate of Dubai, UAE in the year 1996 as a small industry and has gradually developed itself into a fabricator of choice due to its focus on providing quality solution to its customers.</p>
								...
								<div class="hover02 column">
									<div>
										<figure><img src="img/services/CNC-Water-Jet-Cutting.jpg" />
											<h4>CNC Water Jet <br>Cutting</h4>
										</figure>
									</div>
								</div>
							</a>
								...
								<div class="hover02 column">
									<div>
										<figure><img src="img/services/CNC-Tube-and-Pipe-processing.jpg" />
											<h4>CNC Tube & Pipe <br>Processing</h4>
										</figure>
									</div>
								</div>
							</a>
								...
								<div class="hover02 column">
									<div>
										<figure><img src="img/services/Plasma-Oxy-Fuel-and-Machining.jpg" />
											<h4> CNC Plate Processing Center <br> Plasma, Oxy Fuel & Machining </h4>
										</figure>
									</div>
								</div>
							</a>
					...
					<div class="discover-component video-component" id="comp_00002WYS">
						<div class="video-container">
							...
							<div class="video-frame-wrapper">
								<iframe allowfullscreen="" enablejsapi="1" id="comp_00002WYS_frame" class="video-frame" frameborder="0" src="https://www.youtube.com/embed/IgGDgbEYgzs?si=-oEvdC2DaH9zGCYA">
								</iframe>
							</div>
						</div>
					</div>
					...
					<div id="news-slider" class="owl-carousel">
						<div class="row blog-box">
							...
							<div class="col-lg-4 col-md-6 p-0">
								<div class="post-slide">
									<div class="post-img">
										<a href="#"> <img src="img/blog/Precision-Redefined.jpg" alt="blog"> </a>
									</div>
									<div class="post-content">
										<div class="post-date">
							...
							<div class="col-lg-4 col-md-6 p-0">
								<div class="post-slide">
									<div class="post-img">
										<a href="#"> <img src="img/blog/Quality-Meets-Craftsmanship-Surface-Finishing-Excellence-In-Steel-Fabrication.jpg" alt="blog"> </a>
									</div>
									<div class="post-content">
										<div class="post-date">
