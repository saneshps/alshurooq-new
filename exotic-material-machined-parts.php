...
<head>
	...
	<link rel="canonical" href="https://alshurooq.ae/exotic-material-machined-parts.php">
...
<body>
	...
	<section id="banner-ab">
		<div class="ban-cap">
			<!-- <h2>About Us</h2> -->
			<a href="index.php">HOME</a><span> / </span><a href="products.php" class="">PRODUCTS</a> <span> / </span><a class="act">Machining</a><span> / </span><a href="exotic-material-machined-parts.php" class="act-f">Exotic Material Machined Parts</a>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<h2 class="cl">Exotic Material Machined Parts</h2>
					<!-- <p>We fabricate all types of Machined Valves like, Ball Valves, Butterfly valves, Check valves and more according to client’s requirement. </p> -->
					<!-- 
