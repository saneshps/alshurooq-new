...
<head>
	...
	<link rel="canonical" href="https://alshurooq.ae/turret-bearing-assemblies.php">
...
<body>
	...
	<section id="banner-ab">
		<div class="ban-cap">
			<!-- <h2>About Us</h2> -->
			<a href="index.php">HOME</a><span> / </span><a href="products.php" class="">PRODUCTS</a> <span> / </span><a class="act">Vehicle Armour Components</a><span> / </span><a href="turret-bearing-assemblies.php" class="act-f">Turret Bearing Assemblies</a>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<h2 class="cl">Turret Bearing Assemblies</h2>
